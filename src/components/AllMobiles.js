...
const AllMobiles = (props) => {
    ...
    <div class="container">
      ...
      <div class="col-lg-4 offset-lg-1 p-0 overflow-hidden ">
        ...
        <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
          <h1 class="display-4 fw-bold lh-1 text-body-emphasis" style={{fontFamily:'-moz-initial',textShadow: 'rgb(0 216 178 / 50%) 2px 2px 4px'}}>{props.title}</h1>
         
          <p class="lead text-white" style={{textAlign:'justify'}}>{props.desc}</p>
          <h3>Price - ₹{formatIndianNumber(props.Price)}</h3>
      ...
      <h2 class="pb-2 border-bottom" style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)'}}>Product Photos</h2>
      <section >
  ...
  <div class="container my-5" style={{padding:'10px'}}>
    <div class="p-2 text-center  rounded-3"  id="LaptopFeatures">
      ...
      <p class="lead px-5 text-white" style={{textAlign:'justify',display:'flex',justifyContent:'center'}}>
     <span>{props.Operating_System}</span>
      </p>
    </div>
  </div>
  <div class="container my-5" style={{padding:'10px'}}>
  ...
  <div class="container my-5" style={{padding:'10px'}}>
    <div class="p-2 text-center  rounded-3" id="LaptopFeatures">
      ...
      <img src="https://i.pinimg.com/originals/89/c7/ae/89c7ae5c5dee70a437ed825974931b04.gif" id="FeaturesImgs"  class="img-fluid rounded-3 shadow-lg mb-4" alt="Example image" width="100" height="100" loading="lazy"/>
  ...
  <div class="container my-5" style={{padding:'10px'}}>
    <div class="p-2 text-center  rounded-3" id="LaptopFeatures">
      ...
      <h1 class="text">Camera</h1>
     
      <img src="https://www.bing.com/th/id/OGC.aa6b676176f742c2f55a6790dc44e47e?pid=1.7&rurl=https%3a%2f%2fmedia.giphy.com%2fmedia%2fpsneItdLMpWy36ejfA%2fgiphy.gif&ehk=tRa0LVTOXlGuQLHoiHdQBVPzAAKsKvfppAKQf9Mlul4%3d  " id="FeaturesImgs"  class="img-fluid rounded-3 shadow-lg mb-4" alt="Example image" width="100" height="100" loading="lazy"/>
  ...
  <div class="container" style={{padding:'10px'}}>
    <div class="p-2 text-center  rounded-3" id="LaptopFeatures">
      ...
      <h1 class="text" >Battery</h1>
     
      <img src="https://www.bing.com/th/id/OGC.8970fe656af149d9eab23596edb7b899?pid=1.7&rurl=https%3a%2f%2fcdn.dribbble.com%2fusers%2f6705959%2fscreenshots%2f15582515%2fezgif.com-gif-maker__8_.gif&ehk=TbBE%2bc225WVKO9J6DF%2bVnqyPVcQwp4h1XFWOgqAjrps%3d"  id="FeaturesImgs"  class="img-fluid rounded-3 shadow-lg mb-4" alt="Example image" width="100" height="100" loading="lazy"/>
